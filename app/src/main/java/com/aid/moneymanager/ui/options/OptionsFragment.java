...
import com.aid.moneymanager.ui.options.categories.CustomCategoriesActivity;
...
//        });
        ...
        logoutPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            public boolean onPreferenceClick(Preference preference) {
                ...
                broadcastIntent.setAction("com.aid.moneymanager.ACTION_LOGOUT");
    ...
    private void dataUpdated() {
        ...
        currencyPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                alert.setTitle("Pul birligini o'zgartirish");
                ...
                alert.setNegativeButton("Bekor qilish", null);

                alert.setPositiveButton("Saqlash", new DialogInterface.OnClickListener() {
