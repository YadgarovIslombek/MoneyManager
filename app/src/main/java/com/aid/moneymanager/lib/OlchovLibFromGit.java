...
public class OlchovLibFromGit extends View {
    ...
    public OlchovLibFromGit(Context context) {
        super(context);
        init();
    }
    public OlchovLibFromGit(Context context, AttributeSet attrs) {
        super(context, attrs);
